...
puts "2. Спросить как его звать, и узнать что ему нужно?"
puts "3. Вспортоть брюхо этому негодяю. Ибо нефиг тут ошиваться."

choice = gets.chomp

if choice == '1'
  puts "Он сказал, что на самом деле он девочка, и звать её Эльза. У нее есть к вам немного странная просьба.\n"
  puts '1. Выслушать просьбу'
  puts "2. Поржать, и пойти своей дорогой\n"

  choice = gets.chomp

   	if choice == '2'
    puts 'Вы ушли, так и не узнав что хотел Ивасик-Дашасик. Но что поделать, Ивасиков много, а Вы один'
    exit
      else
    puts 'Она просит чтобы Вы ее раскольдовали'
  end
  else
end
